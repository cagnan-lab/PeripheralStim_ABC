function [R p m uc] = MS_periphStim_Model1(R)
% THIS IS THE STN/GPE
% stn only!
m.m = 2; % # of sources
...
p.A{1}(1,2) = 0; % afferent
p.A_s{1}(1,2) = 1/2; % afferent
p.A{1}(2,1) = 0; % efferent
p.A_s{1}(2,1) = 1/2; % efferent
